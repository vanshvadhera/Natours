...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51NY7tqSFncmyCuRW87VaZIyBHpM6q4JgVwyOv11K9sTIHrzHyMUmxyY2cvzptgqzcSp32JN5IXMoirhT4sCxhA0600KAeWxvqC');
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)("/api/v1/bookings/checkOutSession/".concat(tourId));
        case 4:
...
var bookBtn = document.getElementById('book-tour-name');
